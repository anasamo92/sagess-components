...
const Dropdown = {
    ...
    componentWillMount() {
        ...
        console.warn('FocusComponents 2.2.0: this component is deprecated, please use sagess-components/components/dropdown or sagess-components/components/icon-dropdown instead');
